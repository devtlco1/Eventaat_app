...
use App\Filament\Restaurant\Resources\RestaurantMenus\Pages\EditRestaurantMenuCategory;
use App\Filament\Restaurant\Resources\RestaurantMenus\RelationManagers\RestaurantMenuCategoryItemsRelationManager;
use App\Filament\Restaurant\Resources\RestaurantMenus\Schemas\RestaurantMenuCategoryForm;
...
class RestaurantMenuCategoryResource extends Resource
{
    ...
    public static function canEdit($record): bool
    {
        ...
        if (! $record instanceof RestaurantMenuCategory) {
            return false;
        }
