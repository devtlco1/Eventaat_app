...
namespace App\Filament\Restaurant\Resources\Branches\RelationManagers;
...
class BranchAvailabilityRulesRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ->visible(fn (): bool => BranchResource::canEdit($this->getOwnerRecord())
                        && ! $this->getOwnerRecord()->availabilityRule()->exists()),
            ])
            ->actions([
                EditAction::make()
                    ->visible(fn (): bool => BranchResource::canEdit($this->getOwnerRecord())),
