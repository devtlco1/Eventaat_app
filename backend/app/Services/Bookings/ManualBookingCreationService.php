...
class ManualBookingCreationService
{
    ...
    public function create(array $data): Booking
    {
        ...
        $result = $this->validator->validate([
            ...
            'restaurant_event_id' => array_key_exists('restaurant_event_id', $data) ? $data['restaurant_event_id'] : null,
        ...
        $booking = Booking::create([
            ...
            'restaurant_event_id' => array_key_exists('restaurant_event_id', $data) ? ($data['restaurant_event_id'] !== null ? (int) $data['restaurant_event_id'] : null) : null,
            'starts_at' => $startsAt,
            'party_size' => (int) $data['party_size'],
